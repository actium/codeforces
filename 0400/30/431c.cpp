...
std::vector<std::vector<integer>> compute(unsigned n, unsigned k)
{
...
void solve(unsigned n, unsigned k, unsigned d)
{
    const std::vector<std::vector<integer>> idp = compute(n, k), xdp = compute(n, d - 1);
