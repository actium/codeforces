...
public:
    ...
    int search(unsigned target, unsigned lower_bound) const
    {
...
private:
    ...
    unsigned search(const Subtree& subtree, unsigned target, unsigned lower_bound) const
    {
